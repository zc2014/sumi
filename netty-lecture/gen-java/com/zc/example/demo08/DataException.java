...
public class DataException extends Exception implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(DataException other) {
    ...
    DataException typedOther = (DataException)other;
    ...
    lastComparison = Boolean.valueOf(isSetCallStack()).compareTo(typedOther.isSetCallStack());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallStack()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.callStack, typedOther.callStack);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
